...
The [full specification](specification/stable/skills.md) defines the MCP Skills
...
[request metadata](https://modelcontextprotocol.io/specification/draft/basic/index#_meta).
:::
...
operation supports [pagination](https://modelcontextprotocol.io/specification/draft/server/utilities/pagination)
and [caching](https://modelcontextprotocol.io/specification/draft/server/utilities/caching).
...
[`resources/read`](https://modelcontextprotocol.io/specification/draft/server/resources#reading-resources)
...
See the [security requirements](specification/stable/skills.md#security-considerations)
...
See the [client matrix](https://modelcontextprotocol.io/extensions/client-matrix) for Skills support and links
to implementation documentation.

## Specification

Read the [full specification](specification/stable/skills.md) for all requirements.
Development is coordinated by the [Skills Over MCP Working Group](https://modelcontextprotocol.io/community/working-groups/skills-over-mcp).
