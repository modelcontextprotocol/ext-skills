...
| [github-stars-contrib-mcp-server](https://github.com/svg153/github-stars-contrib-mcp-server) | TypeScript | `v1` ([#144](https://github.com/modelcontextprotocol/ext-skills/issues/144)) | Passes the [conformance suite](https://github.com/modelcontextprotocol/conformance/pull/330) server scenarios |
| [github-mcp-server](https://github.com/github/github-mcp-server/pull/2428) | Go | `prototype` | Demo branch, not for merge |
| [mcpkit](https://github.com/panyam/mcpkit) | Go | `partial` ([#780](https://github.com/panyam/mcpkit/issues/780)) | Server and host. v1 security rules; catalog still on the index-resource shape |
...
| [agent-harness](https://github.com/ar27111994/agent-harness) | `planned` ([#492](https://github.com/ar27111994/agent-harness/issues/492)) | Digest-pinned skill store |
